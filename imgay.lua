...
------ Tab
     ...
     local Tab4o = MakeTab({Name = " CLIENT HACK"})
     local Tab5o = MakeTab({Name = " SETTING MENU"})
     local Tab6o = MakeTab({Name = " PREMIUM MENU"})
...
Toggle = AddToggle(Tab6o, {
      Name = "FIX ERRO SCRIPT - [ PREMIUM ]",
      Default = false,
      Callback = function()
     end
    })
Toggle = AddToggle(Tab6o, {
      Name = "FIX ERROR SCRIPT - PRO",
      Default = false,
      Callback = function()
     end
    })
Dropdown = AddDropdown(Tab6o, {
